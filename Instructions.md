...
assignment [Memory Hierarchy Simulation - Part I](https://northeastern.instructure.com/courses/225963/assignments/2831532?wrap=1 "[4 hrs] Assignment / Memory Hierarchy Simulation - Part I").
Copy the assignment's code and modify as necessary and required. You do not have to complete the questions in sequence.

### Tasks and Requirements

#### Part 1 (30 Points) / Caching

* [x] add a cache so that some number of messages are stored in a paged structure
  in memory
...
* [x] messages must be a fixed size (power of 2)
...
* [x] number of messages in the cache and size of the message must be configurable

    * through configuration file stored on disk that is read upon startup OR ~~through global variables in an include
      file~~

* [x] create appropriate lookup data structures for finding messages in the cache
...
* [x] Random Replacement: a replacement "page" is chosen at random
* [x] LIFO: most recently used "page" is replaced
...
* [ ] Devise one or more testing strategies and thoroughly test your cache and page
  replacement.
    * [ ] unit test for message_t
    * [x] unit test for cache_page_t
    * [ ] unit test for cache_t
...
* [ ] Instrument your code and calculate the following cache metrics for LIFO replacement:
...
* [ ] Instrument your code and calculate the following cache metrics for RANDOM replacement:
...
* [ ] Complete the self-evaluation rubric item in the Practicum I
  module ([Complete Self-Evaluation Rubric](https://northeastern.instructure.com/courses/225963/assignments/2831529 "[30 min] DO: Complete Self-Evaluation Rubric (Practicum I Fall 2023)"))
