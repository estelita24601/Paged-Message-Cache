...
// Binary search helper function (recursive version)
...
*/
void __bst__add(bstnode_t * curr, message_t * msg) {
...
int main(const int argc, const char *argv[]) {
    ...
    message *m1 = new_message("J Park", 1);
    message *m2 = new_message("H Potter", 2);
    //message *m6 = new_message("H Potter", 6);
    message *m3 = new_message("S Fighter", 3);
    message *m4 = new_message("A", 4);
    
    message *m5 = new_message("B", 5);
    ...
    bst_add(b, m3);
    bst_add(b, m2);
    //printf("%s\n", b->root->left->right->message->title);

    printf("%s\n", bst_find(b, m3->title)->title);
